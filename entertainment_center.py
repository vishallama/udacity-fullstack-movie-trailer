...
godfather = media.Movie(
    ...
    "position to one of his subalterns, a series of unfortunate events start "
    "happening to the family, and a war begins between all the well-known "
    "families leading to insolence, deportation, murder and revenge, and "
    "ends with the favorable successor being finally chosen.",
    "https://upload.wikimedia.org/wikipedia/en/1/1c/Godfather_ver1.jpg",
    "https://www.youtube.com/watch?v=sY1S34973zA",
    ["Marlon Brando", "Al Pacino", "James Caan", "Richard S. Castellano",
     "Robert Duvall", "Sterling Hayden", "John Marley", "Diane Keaton"],
    "24 March 1972",
    "R",
    "English",
    "175 min",
    ["Paramount Pictures", "Alfran Productions"],
    ["Marlon Brando wanted to make Don Corleone \"look like a bulldog,\" so "
     "he stuffed his cheeks with cotton wool for the audition. For the actual "
     ...
     "Marlon Brando did not memorize most of his lines and read from cue cards "
     "during most of the film.",
     "Al Pacino's maternal grandparents emigrated to America from Corleone, "
     "Sicily, just as Vito Corleone had.",
     "The early buzz on the film was so positive that a sequel was planned "
